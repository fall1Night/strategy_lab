...
<style>
  * { box-sizing:border-box; }
  ...
  .card-title { font-size:16px; margin:0 0 6px; color:#f8fafc; }
  .stats-meta { font-size:13px; color:#94a3b8; margin-bottom:12px; }
  .stat-block { margin-bottom:16px; }
  .stat-block h3 { font-size:13px; color:#93c5fd; margin:0 0 8px; font-weight:700; }
  .stat-item { margin-bottom:10px; }
  .stat-item .row { display:flex; justify-content:space-between; align-items:baseline; font-size:13px; margin-bottom:4px; }
  .stat-item .row .lbl { color:#cbd5e1; }
  .stat-item .row .val { color:#fbbf24; font-weight:700; white-space:nowrap; }
  .stat-item .row .val .frac { color:#64748b; font-weight:500; font-size:12px; }
